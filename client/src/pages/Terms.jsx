...
const Terms = () => {
  return (
    <div className="min-h-screen bg-[#FFF1FE] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#1A495D] mb-2">Terms and Conditions</h1>
          <p className="text-gray-600">Effective Date: Saturday, 31st of May 2025</p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 mb-6">
            Welcome to Talibah (<a href="https://talibah.co.uk" className="text-[#1A495D] hover:underline">https://talibah.co.uk</a>), an Islamic matrimony platform designed for
            Muslims seeking marriage in a manner that upholds Islamic values.
          </p>
          <p className="text-gray-700 mb-8">
            These Terms and Conditions outline the rules of using our platform. By registering on
            Talibah, you agree to these terms in full.
          </p>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#1A495D] mb-3">Free Plan (£0/month):</h3>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#1A495D] mb-3">Gold Plan (£9.99/month):</h3>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#1A495D] mb-3">Platinum Plan (£14.99/month):</h3>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <section>
              ...
              <p className="text-gray-700 mb-2">For questions, support, or data-related inquiries, please contact us at:</p>
              <a href="mailto:info@talibah.co.uk" className="text-[#1A495D] hover:underline">📧 info@talibah.co.uk</a>
            </section>
          </div>
        </div>
      </div>
